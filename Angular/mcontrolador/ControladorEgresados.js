(function() {
    angular.module("primariaAngular").controller("EgresadosCtrl", EgresadosController);

    function EgresadosController($http, $scope, Flash, $auth,validaciones,toastr, servicioalumno, serviciogrupo, servicioevaluar,serviciocurso,  servicioalugrupo) {
        var vm = this;
        ...
        vm.ejecutarFunciones=ejecutarFunciones;
        vm.getCursoActual=getCursoActual;
        vm.llena = llena;
        vm.previoPdf = previoPdf;
        vm.pdf = pdf;
        vm.pdfEgresados = pdfEgresados;
        ...
        function previoPdf(){
            ...
            var cabecera={
             ...
             servicioalugrupo.getLogo().then(function(data) {
                    ...
                    servicioalumno.getEgresados().then(function(data) {
                        lista = data;
                           pdfEgresados(lista,f, cabecera);
                    });
        ...
        function pdfEgresados(arre,f,cabecera){
  ...
  var dd = {
           ...
           columns:[
                ...
                {
                    text: 'LISTA DE ALUMNOS EGRESADOS\n CICLO: '+cabecera.ciclo,fontSize:11,alignment: 'center'               
                },
                {
                     margin: [0, 2, 0, 0],
                    text: '', fontSize:9,  style: 'tableHeader', border: [false, false, false, false], alignment: 'center'
                ...
                [{ 
                    ...
                    width : 140,
                    height: 50, style: 'tableHeader',  alignment: 'right', border: [false, false, false, false]//, rowSpan:4 
                }], 
        ...
        function ejecutarFunciones(id){
          ...
          function cabeceraAlumno(id){
            serviciogrupo.cabeceraBoletaEgresado(id).then(function(data){
          ...
          function evaluaciones(id){
            servicioevaluar.getEvaluacionBimestrales(id).then(function(data){
                vm.eval =data;
                console.log(vm.eval);
                cabeceraAlumno(id);
                calificacionesPorMateria(id);
                calificaionFinal(id);
          ...
          function calificacionesPorMateria(id){
            servicioevaluar.getBoleta(id).then(function(data){
                vm.cal= data;
                console.log(vm.cal);
          ...
          function calificaionFinal(id){
            servicioevaluar.getcaliFinalAlumno(id).then(function(data){
                vm.caliFinal= data;
...
function llena(){
    var anioI= new Date(vm.cabecera[0].anioInicio);
            ...
            var calif={
                ...
                ge1: vm.eval[25].califMateria,
                ge2: vm.eval[26].califMateria,
                ge3: vm.eval[27].califMateria,
                ge4: vm.eval[28].califMateria,
                ge5: vm.eval[29].califMateria,
                hi1: vm.eval[30].califMateria,
                hi2: vm.eval[31].califMateria,
                hi3: vm.eval[32].califMateria,
                hi4: vm.eval[33].califMateria,
                hi5: vm.eval[34].califMateria,
                ma1: vm.eval[35].califMateria,
                ma2: vm.eval[36].califMateria,
                ma3: vm.eval[37].califMateria,
                ma4: vm.eval[38].califMateria,
                ma5: vm.eval[39].califMateria,
            ...
            var ge=parseFloat(vm.cal[5].promedio);
            var geo = ge.toFixed(1);
            var hi=parseFloat(vm.cal[6].promedio);
            var his= hi.toFixed(1);
            var ma=parseFloat(vm.cal[7].promedio);
            var mat=ma.toFixed(1);
           ...
           /* }else{
            ...
            pdf(datos, calif, asistencias,porMateria);
}


function pdf(datos, calif, asis, pormat){
...
var dd = {
    ...
    content: [
        ...
        columns:[
                ...
                {
                    text: 'REPORTE DE EVALUACIÓN',fontSize:11,alignment: 'center'               
                },
                {
                    margin: [ -30, 0, -50, 0 ],
                    text: ['6° GRADO DE EDUCACIÓN PRIMARIA   CICLO ESCOLAR',{text: datos.ciclo}], fontSize:9,  style: 'tableHeader', border: [false, false, false, false], alignment: 'center'
                }
                ],
                //imagen centenario
                [{ 
        ...
        style: 'tableExample',
            table: {
                widths:[100,5,93,10,93,10,85,5,65],
        ...
        style: 'tableExample',
            table: {
                widths:[100,5,250,10,17,3,17,3,60],
                body: [
                ...
                body: [
                    ...
                    [
                        {  // rowSpan:2,
                            colSpan:3,
                            border: [true, true, true, true],
                            text: ''//2daparte ciencias naturales
                        },
                        {
                    ...
                    [
                        ...
                        },
                       {
                            ...
                            fillColor: '#eeeeee',
                            border: [true, true,true,true],
                            text: 'PROMEDIO FINAL DE NIVEL EDUCATIVO'
                        },
