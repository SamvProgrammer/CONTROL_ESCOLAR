(function() {
    angular.module("primariaAngular").controller("BoletadosCtrl", BoletadosController);

    function BoletadosController($http, $scope, Flash, $auth,validaciones,toastr, servicioevaluar, Upload, serviciogrupo, servicioalumno, serviciocurso,serviciocambio) {
        var vm = this;
        vm.llena=llena;
    ...
    content: [
        ...
        columns:[
              //imagen sep
                ...
                {
                  margin: [ -30, 0, -50, 0 ],
                  text: ['2do GRADO DE EDUCACIÓN PRIMARIA   CICLO ESCOLAR: ',{text: datos.ciclo}], fontSize:8,  style: 'tableHeader', border: [false, false, false, false], alignment: 'center'
                }
                ],
                //imagen centenario
                [{ 
