(function() {
    angular.module("primariaAngular").controller("BoletaunoCtrl", BoletaunoController);

    function BoletaunoController($http, $scope, Flash, $auth,validaciones,toastr, servicioevaluar, Upload, serviciogrupo, servicioalumno, serviciocurso,serviciocambio, serviciofolio) {
        var vm = this;
        vm.llena=llena;
        ...
        vm.getEvaluarFolio=getEvaluarFolio;
        ...
        function getAlumnosByDocente() {
          ...
          function getEvaluarFolio(){
            serviciofolio.evaluarfolio(vm.obj.folio).then(function(data){
                vm.obj.folio=" ";
                 swal("Ups!", "Parece que este folio ya esta registrado intente con uno diferente", "error");
            });
        ...
        function obtenerBoleta(){
            servicioalumno.getBoleta(vm.alumnoSelect).then(function(data){
                ...
                vm.apoyos= vm.datos_boleta[0].recom;
                vm.apoyos= vm.datos_boleta[1].recom;
                vm.apoyos= vm.datos_boleta[2].recom;
                vm.apoyos= vm.datos_boleta[3].recom;
                vm.apoyos= vm.datos_boleta[4].recom;
        ...
        function llena(){
            ...
            var calif={
                ea1: vm.eval[0].califMateria,
                ea2: vm.eval[1].califMateria,
                ea3: vm.eval[2].califMateria,
                ea4: vm.eval[3].califMateria,
                ea5: vm.eval[4].califMateria,
                ef1: vm.eval[5].califMateria,
                ef2: vm.eval[6].califMateria,
                ef3: vm.eval[7].califMateria,
                ef4: vm.eval[8].califMateria,
                ef5: vm.eval[9].califMateria,
                es1: vm.eval[10].califMateria,
                es2: vm.eval[11].califMateria,
                es3: vm.eval[12].califMateria,
                es4: vm.eval[13].califMateria,
                es5: vm.eval[14].califMateria,
                ex1: vm.eval[15].califMateria,
                ex2: vm.eval[16].califMateria,
                ex3: vm.eval[17].califMateria,
                ex4: vm.eval[18].califMateria,
                ex5: vm.eval[19].califMateria,
                ...
                ma1: vm.eval[25].califMateria,
                ma2: vm.eval[26].califMateria,
                ma3: vm.eval[27].califMateria,
                ma4: vm.eval[28].califMateria,
                ma5: vm.eval[29].califMateria,
            ...
            var ea=parseFloat(vm.cal[0].promedio);
            var ear = ea.toFixed(1);
            var ef=parseFloat(vm.cal[1].promedio);
            var efi = ef.toFixed(1);
            var fc=parseFloat(vm.cal[2].promedio);
            var fce = fc.toFixed(1);
            var ex=parseFloat(vm.cal[3].promedio);
            var exp = ex.toFixed(1);
            var ma=parseFloat(vm.cal[4].promedio);
            var mat= ma.toFixed(1);
            var es=parseFloat(vm.cal[5].promedio);
        ...
        var recomendaciones={
            ...
            pdf(datos, calif, asistencias,porMateria, recomendaciones, bim, observacionesEspecificas, comprension, riesgo, docentes);
        }
        ...
        function pdf(datos, calif, asis, pormat, reco, bim, obs, comp, ri, doc){
    ...
    content: [
        ...
        columns:[
              //imagen sep
                ...
                {
                  margin: [ -30, 0, -50, 0 ],
                  text: ['1er GRADO DE EDUCACIÓN PRIMARIA   CICLO ESCOLAR: ',{text: datos.ciclo}], fontSize:8,  style: 'tableHeader', border: [false, false, false, false], alignment: 'center'
                }
                ],
                //imagen centenario
                [{ 
                  ...
                  [
                    ...
                    [
                        ...
                        },
                        {
                            colSpan:12,
                            border: [true, false, true, false],
                            text: 'El(la) alumno(a) que concluya el primer grado será\n promovido al segundo grado'
                        },
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            border: [true, true, true, true],
                            text: [{text: asis.total},{fontSize:9},'\nTOTAL INASISTENCIAS' ]
