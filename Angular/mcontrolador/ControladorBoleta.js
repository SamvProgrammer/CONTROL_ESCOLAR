(function() {
    angular.module("primariaAngular").controller("BoletaCtrl", BoletaController);
	
	function BoletaController($auth, $scope,Flash, servicioevaluar ,toastr, serviciogrupo, pdf1) {
	        var vm = this;
          vm.Init = Init;
	        
           
            vm.obtenerBoleta =obtenerBoleta;
            vm.PDFboleta=PDFboleta;
    ...
    content: [
        ...
        columns:[
              //imagen sep
                ...
                {
                  margin: [ -30, 0, -50, 0 ],
                  text: '1er GRADO DE EDUCACIÓN PRIMARIA   CICLO ESCOLAR #', fontSize:9,  style: 'tableHeader', border: [false, false, false, false], alignment: 'center'
                }
                ],
                //imagen centenario
                [{ 
        ...
        style: 'tableExample',
            table: {
                widths:[100,5,250,10,15,5,15,5,60],
                body: [
        ...
        style: 'tableExample',
            table: {
                widths:[11,9,49,15,15,30,30,14,14,14,7,7,6,6,6,1,3,6,6,6,6,3,3,6,6,6,6,6],
                headerRows: 1,
                body: [
