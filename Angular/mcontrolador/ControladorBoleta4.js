(function() {
    angular.module("primariaAngular").controller("BoletacuatroCtrl", BoletacuatroController);

    function BoletacuatroController($http, $scope, Flash, $auth,validaciones,toastr,  servicioevaluar, Upload, serviciogrupo, servicioalumno, serviciocurso,serviciocambio) {
        var vm = this;
        vm.llena=llena;
...
var dd = {
    ...
    content: [
        ...
        columns:[
                ...
                {
                    margin: [ -30, 0, -50, 0 ],
                    text:[ '4° GRADO DE EDUCACIÓN PRIMARIA   CICLO ESCOLAR ', {text:datos.ciclo}],fontSize:8,  style: 'tableHeader', border: [false, false, false, false], alignment: 'center'
                }
                ],
                //imagen centenario
                [{ 
